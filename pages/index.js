...
export default function IndexPage() {
  return (
    <div>
      ...
      <main>
        <section className={`relative h-screen ${styles.bgImage}`}>
          <nav className="h-24 sm:h-32 flex items-center w-full">
            <div className="container mx-auto px-6 justify-between">
              <div className="uppercase text-gray-800 font-semibold text-xl">
                Ofori James Ayerakwa
              </div>
              <div className="flex items-center">
                <a href="mailto:jamesofoaye@gmail.com?subject=Hi James, Found you via your website☺">
                  <div className="font-sen text-gray-800 uppercase text-sm md:text-lg">
                    <div className="uppercase text-gray-800 text-3xl font-semibold">
                      ...
                      <span className="text-md md:text-xl ml-3 mt-1">
          ...
          <div className="flex relative items-center">
            <div className="container mx-auto px-6 flex flex-col justify-between pt-4">
              <div className="flex flex-col">
                ...
                <p className="lg:max-w-3xl text-md md:text-3xl mx-auto text-gray-800 text-center py-2">
        ...
        <section className="bg-white px-4 pt-16 mx-auto md:px-24 lg:px-8 lg:pt-20 lg:pb-8">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold text-gray-900 sm:text-5xl md:mx-auto capitalize">
              What am i good at?
            </h2>
          </div>

          <div className="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-7 sm:grid-cols-2">
            <div className="absolute inset-0 flex items-center justify-center sm:hidden lg:flex">
              <div className="w-px h-full bg-gray-300 lg:w-full lg:h-px" />
            </div>
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
              <img src="/tools-icons/HTML.svg" className="h-full" />
            </div>
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
        ...
        <section className="bg-white px-4 pb-16 mx-auto md:px-24 lg:px-8">
          <div className=" mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 className="mb-4 font-sans text-3xl font-bold text-gray-900 sm:text-5xl md:mx-auto capitalize">
              Where have i worked?
            </h2>
          ...
          <div className="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-5 sm:grid-cols-2">
            ...
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
              <img src="/company-logos/seguah.jpg" />
            ...
            <div className="p-5 duration-300 transform bg-black border rounded shadow-sm hover:-translate-y-2">
              <img src="/company-logos/mcat-global.svg" className="mt-10" />
            ...
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
              <img src="/company-logos/dawurobo.png" />
            ...
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
              <img src="/company-logos/hexlen.svg" />
            ...
            <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
              <img src="/company-logos/skinplus-medspa.png" className="mt-10" />
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center -mx-2">
                <a className="flex items-center mx-2 text-white hover:text-teal-700"
                  href="https://www.linkedin.com/in/james-ayerakwa-ofori-212b9117a/" target="_blank">
                ...
                <a className="flex items-center mx-2 text-white hover:text-teal-700"
                  href="https://github.com/jamesofoaye" target="_blank">
                ...
                <a className="flex items-center mx-2 text-white hover:text-teal-700"
                  href="https://twitter.com/iamrholing" target="_blank">
                ...
                <a className="flex items-center mx-2 text-white hover:text-teal-700"
                  href="https://api.whatsapp.com/send?phone=233555175699&text=Hello%20James%2C%20I%20found%20your%20number%20via%20your%20website." target="_blank">
                  <svg className="h-5 w-5 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
