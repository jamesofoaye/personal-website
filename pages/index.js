        ...
        <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl opacity-75 mx-6 mt-8 lg:mt-0 lg:mx-0">
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
              <button>
                <Link href="https://web.facebook.com/james.ayerakwa.7/">
              ...
              <button>
                <Link href="https://twitter.com/iamrholing">
                  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <button>
                <Link href="https://github.com/jamesofoaye">
                  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <button>
                <Link href="https://api.whatsapp.com/send?phone=233555175699&text=Hello%20James%2C%20I%20found%20your%20number%20via%20your%20website.">
                  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <button>
                <Link href="https://www.linkedin.com/in/james-ayerakwa-ofori-212b9117a/">
                  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
