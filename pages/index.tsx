								...
								>
									<div className="font-sen text-gray-800 uppercase text-sm md:text-lg flex items-center">
										<div className="uppercase text-gray-800 md:text-3xl font-semibold flex items-center">
											...
											<span className="text-sm md:text-xl ml-3 mt-1">jamesofoaye@gmail.com</span>
										</div>
									</div>
								</a>
							</div>
						...
						<div className="container mx-auto px-6 flex flex-col justify-between pt-4">
							<div className="flex flex-col">
								...
								<p className="lg:max-w-3xl text-xl md:text-3xl mx-auto text-gray-800 text-center md:py-2 pb-4">
									A Frontend developer with a strong eye for innovative design and a keen
				...
				<section className="bg-white px-4 pb-16 mx-auto md:px-24 lg:px-8">
					<div className="mb-10 mx-auto text-center lg:max-w-2xl md:mb-12">
						...
						<p className="text-2xl text-gray-900">
							Freelancing is liberating, but working for different companies surrounded by genius
							colleagues has helped me grow a lot.
						</p>
					</div>
					...
					<div className="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-5 sm:grid-cols-2">
						...
						<div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
							<img
								...
								alt="Seguah logo"
							/>
							<a href="https://seguah.com" target="_blank" title="Seguah Website Link">
						...
						<div className="p-5 duration-300 transform bg-black border rounded shadow-sm hover:-translate-y-2">
							...
							/>
							<a href="https://mcatglobal.com" target="_blank" title="MCAT Global Website Link">
						...
						<div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
							<img
								...
								alt="Dawurobo logo"
							/>
							<a href="https://dawurobo.com" target="_blank" title="Dawurobo Website Link">
							...
							<p className="text-md text-gray-900">
								...
								a web app that help individuals engage in a safe transaction. I also maintain
								Dawurobo's Game and Main website.
							</p>
						</div>
						<div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
							<img
								...
								alt="Hexlen logo"
							/>
							<a href="https://hexlen.com" target="_blank" title="Hexlen Website Link">
						...
						<div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
							...
							>
								<h3 className="text-center text-gray-900 py-3 text-xl font-bold">
									SkinPlus Medspa
								</h3>
							</a>
							<p className="text-md text-gray-900 text-center">
						...
						<div className="md:flex text-center md:justify-between md:items-center">
							<div>
								<div className="text-white">
									&copy; Ofori James Ayerakwa - {new Date().getFullYear()}
								</div>
							</div>
