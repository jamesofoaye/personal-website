...
export default function Portfolio() {
    ...
    const [state, handleSubmit] = useForm('1545700498336644988');
    if (state.succeeded) {
        return <div>Thank you for opting-in to be notified when my portfolio is ready!</div>;
    }
        ...
        <div>
            ...
            <div className="portfolio-bg">
                <span className="flex justify-center">
                    <svg class="h-12 w-16 lg:w-12 text-teal-700 ml-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
